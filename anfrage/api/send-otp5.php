...
/* ── CONFIG ── */
$secrets = is_file(__DIR__ . '/_secrets.php') ? (require __DIR__ . '/_secrets.php') : [];

$SB_URL    = 'https://uledkuegmaritmsjejlm.supabase.co';
$SB_KEY    = (string)($secrets['SUPABASE_SERVICE_ROLE'] ?? 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InVsZWRrdWVnbWFyaXRtc2plamxtIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3MTU4OTkyOSwiZXhwIjoyMDg3MTY1OTI5fQ.YXRbn9JAmKWxxMNTjRbLnT47FbNJ40juOr0XCNVjwWU');
...
$FROM_EMAIL = 'info@grapify-media.de';
$FROM_NAME  = 'AnfrageBox';
...
if ($SMTP_PASS === '') {
    error_log('[send-otp] SMTP_PASS missing in _secrets.php');
    http_response_code(500);
