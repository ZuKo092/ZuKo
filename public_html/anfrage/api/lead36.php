...
$OWNER_EMAIL = 'info@grapify-media.de';
...
if ($SERVICE_ROLE === '') $SERVICE_ROLE = envv('SUPABASE_SERVICE_ROLE');
if ($SMTP_PASS === '')    $SMTP_PASS    = envv('SMTP_PASS');
...
curl_setopt_array($notifyCh, [
  ...
  CURLOPT_HTTPHEADER => [
    'Content-Type: application/json',
    'X-Internal-Token: ' . ($secrets['CRON_TOKEN_FOLLOWUP'] ?? ''),
  ],
